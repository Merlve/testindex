      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={`absolute ${alignClasses} top-full mt-3 w-36 p-1.5 rounded-2xl border backdrop-blur-3xl backdrop-saturate-[200%] shadow-2xl z-50 text-xs font-semibold space-y-1 transition-all duration-300 ${
              isUnderlyingDark
